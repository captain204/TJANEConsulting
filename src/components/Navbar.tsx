...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Sidebar Drawer */}
      <div
        className={`fixed top-0 left-0 h-full w-64 sm:w-80 md:w-96 bg-slate-800 bg-opacity-95 backdrop-blur-sm shadow-2xl z-[9999] transform transition-transform duration-300 ease-in-out overflow-y-auto ${drawerOpen ? "translate-x-0" : "-translate-x-full"
          }`}
      >
        <div className="p-8">
          <nav className="mt-12 space-y-6">
            ...
            <Link
              ...
              className={`flex items-center justify-between text-lg font-semibold transition-colors group ${isActive("/")
                  ? "text-green-400"
            ...
            <div>
              ...
              >
                ...
                <ChevronDown
                  className={`w-5 h-5 transform transition-transform ${servicesOpen ? "rotate-180 text-green-400" : ""
                    }`}
                />
              </button>
                  ...
                  >
                    ...
                    <motion.div whileHover={{ scale: 1.03, x: 4 }}>
                      <Link
                        href="/credentialling"
                        onClick={handleLinkClick}
                        className={`flex items-start gap-3 transition-colors ${isActive("/credentialling")
                            ? "text-green-400"
                    ...
                    <motion.div whileHover={{ scale: 1.03, x: 4 }}>
                      <Link
                        href="/billing-audit"
                        onClick={handleLinkClick}
                        className={`flex items-start gap-3 transition-colors ${isActive("/billing-audit")
                            ? "text-green-400"
                            : "text-slate-200 hover:text-green-400"
                          }`}
                      >
                    ...
                    <motion.div whileHover={{ scale: 1.03, x: 4 }}>
                      <Link
                        ...
                        onClick={handleLinkClick}
                        className={`flex items-start gap-3 transition-colors ${isActive("/healthcare-operations")
                            ? "text-green-400"
                            : "text-slate-200 hover:text-green-400"
                          }`}
                      >
                    ...
                    <motion.div whileHover={{ scale: 1.03, x: 4 }}>
                      <Link
                        ...
                        onClick={handleLinkClick}
                        className={`flex items-start gap-3 transition-colors ${isActive("/revenue-cycle-management")
                            ? "text-green-400"
                            : "text-slate-200 hover:text-green-400"
                          }`}
                      >
                    ...
                    <motion.div whileHover={{ scale: 1.03, x: 4 }}>
                      <Link
                        ...
                        onClick={handleLinkClick}
                        className={`flex items-start gap-3 transition-colors ${isActive("/compliance-training")
                            ? "text-green-400"
                            : "text-slate-200 hover:text-green-400"
                          }`}
                      >
                    ...
                    <motion.div whileHover={{ scale: 1.03, x: 4 }}>
                      <Link
                        ...
                        onClick={handleLinkClick}
                        className={`flex items-start gap-3 transition-colors ${isActive("/healthcare-business")
                            ? "text-green-400"
                            : "text-slate-200 hover:text-green-400"
                          }`}
                      >
            ...
            <Link
              href="/about-us"
              onClick={handleLinkClick}
              className={`flex items-center justify-between text-lg font-semibold group transition-colors ${isActive("/about-us")
                  ? "text-green-400"
                  : "text-white hover:text-green-400"
                }`}
            >
            ...
            <Link
              href="/reviews"
              onClick={handleLinkClick}
              className={`flex items-center justify-between text-lg font-semibold group transition-colors ${isActive("/reviews")
                  ? "text-green-400"
                  : "text-white hover:text-green-400"
                }`}
            >
            ...
            <Link
              href="/contact-us"
              onClick={handleLinkClick}
              className={`flex items-center justify-between text-lg font-semibold group transition-colors ${isActive("/contact-us")
                  ? "text-green-400"
                  : "text-white hover:text-green-400"
                }`}
            >
