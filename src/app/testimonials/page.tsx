...
const testimonials = [
  {
    ...
    image: "/doctor1.jpg",
    quote:
      "TJane Healthcare transformed our Hospital’s operations. From billing to patient flow, everything is now smoother and more efficient. Their team truly cares about your success.",
  },
  {
    name: "Michael Smith",
  ...
  return (
    <>
        <HeroSection
            ...
            subtitle=" Hear from healthcare professionals who trust TJane Healthcare to make their Hospitals work better and earn better."
    ...
    <section className="relative bg-gradient-to-b from-blue-50 via-white to-blue-50 py-20 px-6 md:px-16 overflow-hidden">
      ...
      {/* <div className="relative z-10 text-center mb-16">
        ...
        >
          Hear from healthcare professionals who trust{" "}
          <span className="font-semibold text-blue-700">TJane Healthcare</span>{" "}
          to make their Hospitals work better and earn better.
        </motion.p>
      </div> */}
